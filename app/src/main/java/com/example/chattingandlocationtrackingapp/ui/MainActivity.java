...
import com.example.chattingandlocationtrackingapp.UserClient;
import com.example.chattingandlocationtrackingapp.adapters.ChatroomRecyclerAdapter;
import com.example.chattingandlocationtrackingapp.models.Chatroom;
...
import com.example.chattingandlocationtrackingapp.services.LocationService;
...
import static com.example.chattingandlocationtrackingapp.Constants.ERROR_DIALOG_REQUEST;
import static com.example.chattingandlocationtrackingapp.Constants.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static com.example.chattingandlocationtrackingapp.Constants.PERMISSIONS_REQUEST_ENABLE_GPS;
...
//        this.startService(serviceIntent);
    ...
    private boolean isLocationServiceRunning() {
        ...
        for (ActivityManager.RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)){
            if("com.example.chattingandlocationtrackingapp.services.LocationService".equals(service.service.getClassName())) {
            ...
            userRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    if (task.isSuccessful()) {
                        Log.d(TAG, "Successfully get userDetails");
    ...
    private void saveUserLocation() {
        if (mUserLocation != null) {
            DocumentReference locationRef =
                    mDb.collection(getString(R.string.collection_user_locations))
                            .document(FirebaseAuth.getInstance().getUid());
            ...
            locationRef.set(mUserLocation).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Log.d(TAG, "Add geo point to firebase successfully");
                    }
                }
