...
import static com.example.chattingandlocationtrackingapp.util.Check.doStringsMatch;
        ...
        View.OnClickListener
{
     ...
     * @param email where user enter valid email
     * @param password where user set password
     */
